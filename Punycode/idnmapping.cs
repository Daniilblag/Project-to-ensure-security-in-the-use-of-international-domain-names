namespace test
{
    ...
    public sealed class IdnMappings
    {
        ...
        public String GetAscii(String unicode, int index, int count)
        {
            ...
            if (unicode[unicode.Length - 1] <= 0x1f)
            {
                throw new ArgumentException(
                    GetResourceString("Argument_InvalidCharSequence", unicode.Length-1 ),
                    "unicode");
            }
        ...
        private String GetAsciiUsingOS(String unicode)
        {
            ...
            if (length == 0)
            {
                ...
                {
                    throw new ArgumentException(GetResourceString("Argument_IdnIllegalName"), "unicode");
                }
                
                throw new ArgumentException(GetResourceString("Argument_InvalidCharSequenceNoIndex"), "unicode");
            }
        ...
        public String GetUnicode(String ascii, int index, int count)
        {
            ...
            if (count > 0 && ascii[index + count - 1] == (char)0)
                throw new ArgumentException("ascii",
                    GetResourceString("Argument_IdnBadPunycode"));
            Contract.EndContractBlock();
        ...
        private string GetUnicodeUsingOS(string ascii)
        {
            ...
            if (length == 0)
            {
                ...
                if (lastError == ERROR_INVALID_NAME)
                {
                        throw new ArgumentException(GetResourceString("Argument_IdnIllegalName"), "ascii");
                }
                
                throw new ArgumentException(GetResourceString("Argument_IdnBadPunycode"), "ascii");
            }
        ...
        {
            IdnMappings that = obj as IdnMappings;
        ...
        static bool ValidateStd3AndAscii(string unicode, bool bUseStd3, bool bCheckAscii)
        {
            ...
            for (int i = 0; i < unicode.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(
                        GetResourceString("Argument_InvalidCharSequence", i ),
                        "unicode");
                }
        ...
        static String punycode_encode(String unicode)
        {
            ...
            while (iNextDot < unicode.Length)
            {
                ...
                BidiCategory eBidi = GetBidiCategory(unicode, iAfterLastDot);
                if (eBidi == BidiCategory.RightToLeft || eBidi == BidiCategory.RightToLeftArabic)
                {
                    ...
                    eBidi = GetBidiCategory(unicode, iTest);
                    if (eBidi != BidiCategory.RightToLeft && eBidi != BidiCategory.RightToLeftArabic)
                    {
                ...
                for (basicCount = iAfterLastDot; basicCount < iNextDot; basicCount++)
                {
                    ...
                    BidiCategory testBidi = GetBidiCategory(unicode, basicCount);
...
//                    }
        ...
        //                }
                    ...
                    // Check for RTL.  If right-to-left, then 1st & last chars must be RTL
                    BidiCategory eBidi = GetBidiCategory(output.ToString(), iOutputAfterLastDot);
                    if (eBidi == BidiCategory.RightToLeft || eBidi == BidiCategory.RightToLeftArabic)
                    {
                        // It has to be right to left.
                        bRightToLeft = true;
                    ...
                    for (int iTest = iOutputAfterLastDot; iTest < output.Length; iTest++)
                    {
                        ...
                        eBidi = GetBidiCategory(output.ToString(), iTest);
